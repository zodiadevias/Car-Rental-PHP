...
<head>
  ...
  <title>WE-GO! Car Rental | Contact Us Page</title>
  <!--Bootstrap -->
              ...
              foreach ($results as $result) { ?>
                <ul>
                  ...
                  <li>
                    ...
                    <div class="contact_info_m"><a href="tel:+63<?php echo htmlentities($result->ContactNo); ?>"><?php echo htmlentities($result->ContactNo); ?></a></div>
                  </li>
                  <li>
