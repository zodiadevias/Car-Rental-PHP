...
?>
  ...
  <head>
    ...
    <title>WE-GO! Car Rental | My Booking</title>
    <!--Bootstrap -->
        ...
        <section class="user_profile inner_pages">
          <div class="container">
            <div class="user_profile_info gray-bg padding_4x4_40">
              ...
              <div style="float:left;" class="dealer_info">
                            ...
                            <li>
                              ...
                              <?php } else { ?>
                                <div class="vehicle_status"> <a href="#" class="btn outline btn-xs">Not Confirmed yet</a>
                                  <a style="width: 152px;background-color: red" href="cancel-booking.php?bookingno=<?php echo $result->BookingNumber; ?>" onclick="return confirm('Are you sure you want to cancel this booking?');" class="btn outline btn-xs">Cancel Booking</a>
                                  <div class="clearfix"></div>
                                </div>
                              <?php } ?>
